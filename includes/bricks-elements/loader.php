...
function evk_elements_registry(): array {
    ...
    return [
        ...
        'stacking_cards' => [
            ...
            'consts'=> [
                'EVK_SC_VERSION' => '1.1.0',
                'EVK_SC_URL'     => $url . 'evoke-stacking-cards/',
                'EVK_SC_PATH'    => $dir . 'evoke-stacking-cards/',
            ],
            'script'=> ['evk-stacking-cards', $url . 'evoke-stacking-cards/assets/stacking-cards.js', ['evk-gsap', 'evk-scrolltrigger'], '1.1.0'],
            'style' => ['evk-stacking-cards', $url . 'evoke-stacking-cards/assets/stacking-cards.css', '1.1.0'],
        ],
        'wave_bg' => [
