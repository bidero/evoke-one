                        ...
                        <div class="evo-status-card">
                            ...
                            <div class="evo-status-actions">
                                <label class="evo-toggle">
                                    <input aria-label="Kokpit Bricks" type="checkbox" name="evoke_dashboard_active" data-option="evoke_dashboard_active" data-field="_scalar" value="1" <?php checked(get_option('evoke_dashboard_active'), '1'); ?>>
                                    <span class="evo-slider"></span>
                                </label>
                            </div>
                        </div>
                        <div class="evo-grid evo-mb-lg" style="--evo-col:200px">
                            <div class="evo-field evo-mb-0"><label for="evo-f-evoke_dashboard_page_id">Strona Bricks Builder</label><?php wp_dropdown_pages(['name' => 'evoke_dashboard_page_id', 'id' => 'evo-f-evoke_dashboard_page_id', 'selected' => (int) get_option('evoke_dashboard_page_id', 0), 'show_option_none' => '— wybierz —']); ?></div>
                            <div class="evo-field evo-mb-0"><label for="evo-f-evoke_dashboard_mode">Tryb</label><select id="evo-f-evoke_dashboard_mode" name="evoke_dashboard_mode"><option value="above" <?php selected(get_option('evoke_dashboard_mode', 'above'), 'above'); ?>>Oddzielony</option><option value="replace" <?php selected(get_option('evoke_dashboard_mode'), 'replace'); ?>>Dolepiony</option></select></div>
                            <div class="evo-field evo-mb-0"><label for="evo-f-evoke_dashboard_width">Szerokość</label><input id="evo-f-evoke_dashboard_width" type="text" name="evoke_dashboard_width" value="<?php echo esc_attr(get_option('evoke_dashboard_width', '100%')); ?>" class="evo-w" style="--evo-w:100px"></div>
                            <div class="evo-field evo-mb-0"><label for="evo-f-evoke_dashboard_height">Wysokość</label><input id="evo-f-evoke_dashboard_height" type="text" name="evoke_dashboard_height" value="<?php echo esc_attr(get_option('evoke_dashboard_height', '600px')); ?>" class="evo-w" style="--evo-w:100px"></div>
                            <div class="evo-field evo-mb-0"><label for="evo-f-evoke_dashboard_scrolling">Paski przewijania</label><select id="evo-f-evoke_dashboard_scrolling" name="evoke_dashboard_scrolling"><option value="auto" <?php selected(get_option('evoke_dashboard_scrolling', 'auto'), 'auto'); ?>>Auto</option><option value="yes" <?php selected(get_option('evoke_dashboard_scrolling'), 'yes'); ?>>Zawsze</option><option value="no" <?php selected(get_option('evoke_dashboard_scrolling'), 'no'); ?>>Ukryte</option></select></div>
                        </div>
