...
| `admin-style.test.js` | checkbox w etykiecie flex bez `flex-shrink: 0` ściska się w poziomie i przestaje być kwadratem; przejście na tokeny CSS nie może przemalować panelu — druga, częściowa deklaracja zmiennych zamieniła się w samoodwołanie i wyzerowała tło kart (1.41.0) |
